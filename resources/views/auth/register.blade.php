    ...
    <div class="row row-cols-1 row-cols-lg-2 sign-up">
        ...
        <div class="col d-flex justify-content-center align-items-center">
            <div class="p-x-70 p-y-20">
                <h1 class="text-theme-primary text-uppercase mb-0 text-center fs-18 fw-bold">Sign up FOR Solution for Recruiter, Employer and Applicant</h1>
                ...
                <form method="POST" action="{{ route('register') }}" class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control fs-14 bg-theme-secondary border-0 h-50px" id="">
                    </div>
                    <div class="col-12">
