            ...
            <div class="row justify-content-center  py-lg-5 py-3 mt-5">
                <div class="col-lg-10">
                    <div class="row pb-lg-5 pb-3">
                        <div class="col-lg-2">
                            @if(isset($cand->user->avatar))
                                <img src="{{ asset('storage/'.$cand->user->avatar) }}" alt="profile-img" class="img-fluid" width="128" height="128">
                            @else
                        ...
                        <div class="col-lg-9 details">
                            <span class="title text-theme-primary fw-bold">{{ $cand->first_name }} {{ $cand->last_name }}</span>
                            <p class="fs-14 mb-0 pt-1">{{ $cand->head_line }}</p>
                            <div class="rate">
                                <div class="rating">
                    ...
                    <div class="mb-5">
                        ...
                        <ul class="pt-4 fs-18 ">
                            <li class="row">
                                ...
                                <div class="col-lg-3">
                                    <a href="#" class="text-theme-primary">{{ $edu->education }}</a>
                                </div>
                                <div class="col-lg-3">
                                    <a href="#" class="text-theme-primary">{{ $edu->institute }}</a>
                                </div>
                                <div class="col-lg-3">
                                    <a href="#" class="text-theme-primary">{{ $edu->passing_year }}</a>
                                </div>
                            </li>
                            {{-- <li class="row">
                                <div class="col-lg-4">
                                ...
                                <div class="col-lg-8">
                                    <a href="#" class="text-theme-primary">{{ $edu->course }}</a>
                                </div>
                            </li>
                            <li class="row">
                                <div class="col-lg-4">
                        ...
                        <div class="card p-2 m-2 b-2 px-5">
                            <ul class="pt-4 fs-18 ">
                                <li class="row">
                                    ...
                                    <div class="col-lg-8">
                                        <a href="#" class="text-theme-primary">{{ $pro->company_name }}</a>
                                    </div>
                                </li>
                                <li class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-8">
                                        <a href="#" class="text-theme-primary">{{ $pro->designation }}</a>
                                    </div>
                                </li>
                                <li class="row">
                                    <div class="col-lg-4">
                                    ...
                                    <div class="col-lg-8">
                                        <a href="#" class="text-theme-primary">{{ $pro->year_exp }}</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
