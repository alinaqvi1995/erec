...
<body>
                ...
                <form method="post" action="{{ route('candidates.applyNow') }}" enctype="multipart/form-data">
                    ...
                    <div class="drag">
                        ...
                        <div class="drag-text">
                            ...
                            <span class="error">File not allowed <br> <i>Allowed Files: pdf, docx, doc</i></span>
                        </div>
                    </div>
                    <div class="cv-list">
                        <ul>
                            ...
                            <li>
                                ...
                                <a href="{{ asset('candidateDoc/doc/'.$row->document) }}" target="_blank">{{ pathinfo($row->document, PATHINFO_EXTENSION) }}</a>
                            </li>
                            @endforeach
                            {{-- <li>
                                <div class="wrap">
                        ...
                        <button type="submit" oncanplay="UploadFile()" class="action-btn upload">Submit</button>
                    </div>
                </form>
            </div>

            <!-- <span class="file-title">Uploaded Image</span> -->
            <!-- <div class="file-upload-content">
                <img class="file-upload-image" src="#" alt="your image" />
                <div class="file-title-wrap">
                    <button type="button" onclick="removeUpload()" class="action-btn">Remove
                        <span class="file-title">Uploaded Image</span>
                    </button>
                    <button type="button" oncanplay="UploadFile()" class="action-btn upload">Upload file</button>
                </div>
            </div> -->
        </div>
    </div>
    ...
    <script>
        $('#recruiters').click(function() {
            $(this).append('<animateTransform id="rec" attibuteName="transform" attributeType="XML" type="translate" from="434.463 341.237" to="57.8 318.7" dur="2s"/>')
        });
