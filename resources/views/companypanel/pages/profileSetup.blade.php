...
@endsection
    ...
    <div class="container">
        <div class="heading">
            ...
            <img id="imagePreview" src="{{ asset('storage/'.$user->company->logo) }}" width="100px" height="100px"/>
                ...
                <div class="col-lg-2">
                    <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                @if($user->company->logo != NULL)
                                <div id="imagePreview" style="background-image: url({{ asset('storage/'.$user->company->logo) }});">
                                </div>
                                @else
