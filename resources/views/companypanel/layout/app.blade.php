  ...
  <body class="h-100">
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!-- Sidebar  Section -->
            @include('companypanel.includes.sidebar')


            <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
                <div class="main-navbar sticky-top bg-white">
                    @include('companypanel.includes.header')
          ...
          <div class="main-content-container container-fluid px-4">
           ...
           <!-- Main Footer -->
            @include('companypanel.includes.footer')
        </main>
      </div>
    </div>
    ...
    <!-- Comment because graphs are not important -->
      ...
      <script script src="{{asset('adminpanel/js/jquery_3.3.1.min.js')}}"  crossorigin="anonymous"></script>
