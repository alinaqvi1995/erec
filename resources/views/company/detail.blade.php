            ...
            <div class="container">
                <div class="row justify-content-center align-items-center py-lg-5 py-3">
                    <div class="col">
                        ...
                        <h1 class="mb-0 fs-48 text-center fw-bold text-uppercase mt-5 pt-5">COMPANY DETAILS
                        </h1>
                            @csrf
                            <!-- progressbar -->
                            {{-- <ul id="progressbar">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="avatar-upload">
                                                ...
                                                <div class="avatar-preview">
                                                    @if($logo != NULL)
                                                        <div id="imagePreview" style="background-image: url({{ asset('storage/'.$logo) }});">
                                                        </div>
                                                    @else
                            ...
                            <fieldset>
                                ...
                                <div class="row row-cols-1">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="row">
                                            <div class="col-2">
                                                <input type="tel" class="form-control fs-14 h-50px w-60" maxlength="3" value="{{ $country_code }}" name="country_code" >
                                            </div>
                                            <div class="col-5">
                                                <input type="tel" class="form-control fs-14 h-50px" name="phone" value="{{ $phone }}">
                                            </div>
                                        </div>
                                    </div>
                                    {{-- <div class="col">
