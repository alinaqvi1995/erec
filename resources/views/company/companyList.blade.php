    ...
    <section>
        <div class="container">
            <div class="row justify-content-center align-items-center py-lg-5 py-3">
                <div class="col">
                    <h1 class="mb-0 fs-48 text-center fw-bold text-uppercase mt-5 pt-5">Companies </h1>
                </div>
            </div>
            <div class="row justify-content-center">
                ...
                <div class="col-lg-8">
                    <div class="d-lg-flex justify-content-between align-items-center py-2 mb-3 px-2">
                        <h3 class="mb-0 fs-5 fw-bold">Showing 1-{{ $comp->total() }} Of {{ $count }} Employers</h3>
                    ...
                    <div class="card horizontal-view py-3 mb-3">
                        <div class="card-body row align-items-center">
                            <div class="col-lg-2 text-center">
                                @if(isset($cmp->logo))
                                    <img src="{{ asset('storage/'.$cmp->logo) }}" alt="profile-img" class="img-fluid" width="128" height="128">
                                @else
                            ...
                            <div class="col-lg-7">
                                <div class="details">
                                    <span class="title fw-bold text-theme-primary">{{ $cmp->name }}</span>
                                    <p class="line-climp">{!! $cmp->description !!}</p>
                                    @foreach ($cmp->features as $fea)
                            ...
                            <div class="col-lg-3">
                                <div class="btns d-flex flex-column">
                                    <a href="{{ route('job.details',$cmp->id ) }}" class="btn default-btn mb-3">View profile</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    {{-- <div class="card horizontal-view py-3 mb-3">
                        <div class="card-body row align-items-center">
                            ...
                            <div class="col-lg-7">
                                <div class="details">
                                    <span class="title fw-bold text-theme-primary">Comany Name</span>
                                    <p class="line-climp">
