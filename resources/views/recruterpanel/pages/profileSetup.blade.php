    ...
    <div class="heading">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <img id="imagePreview" src="{{ asset('storage/'.$user->recruiter->avatar) }}" width="100px" height="100px"/>
                ...
                <div class="col-lg-2">
                    <div class="avatar-upload">
                            ...
                            <div class="avatar-preview">
                                @if($user->recruiter->avatar != NULL)
                                <div id="imagePreview" style="background-image: url({{ asset('storage/'.$user->recruiter->avatar) }});">
                                </div>
                                @else
