                                ...
                                <div class="card-body row align-items-center">
                                    <div class="col-lg-2">
                                        @if ($row->user->avatar != NULL)
                                            <img src="{{ asset('storage/'.$row->user->avatar) }}" alt="profile-img"  width="100" height="100" style="border-radius: 100px;">
                                        @else
                                    ...
                                    <div class="col-lg-3">
                                        <div class="btns d-flex flex-column">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="mailto:{{ $row->user->email }}"><img src="{{ asset('images/mail.svg ') }}" alt="" class="img-fluid"></a>
