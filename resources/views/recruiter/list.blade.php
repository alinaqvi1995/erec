        ...
        <section>
            <div class="container">
                <div class="row justify-content-center align-items-center py-lg-5 py-3">
                    <div class="col">
                        <h1 class="mb-0 fs-48 text-center fw-bold text-uppercase mt-5 pt-5">All recruiters</h1>
                    </div>
                </div>
                <div class="row justify-content-center">
                    <div class="col-lg-4">
                        <form action="" class="row row-cols-1 search-area mb-3 py-4 px-3 position-relative">
                            ...
                            <div class="col">
                                <input type="text" class="w-100 fs-14 bg-theme-secondary px-5 text-dark h-50px"
                    ...
                    <div class="col-lg-8">
                        <div class="d-lg-flex justify-content-between align-items-center py-2 mb-3 px-2">
                            <h3 class="mb-0 fs-5 fw-bold">Showing 1-{{ $rec->total() }} Of {{ $count }} Recruiters</h3>
                                ...
                                <div class="col">
                                    <div class="row row-cols-1 row-cols-lg-3">
                                        ...
                                        <div class="col px-lg-0">
                                            <select id="role"
                                                class="form-select fs-14 mb-lg-0 mb-2 h-50px bg-theme-secondary">
                            ...
                            <div class="card horizontal-view py-3 mb-3">
                                <div class="card-body row align-items-center">
                                    <div class="col-lg-2 text-center">
                                        @if (isset($re->avatar))
                                            <img src="{{ asset('storage/' . $re->avatar) }}" alt="profile-img"
                                                class="img-fluid" width="128" height="128">
                                        @else
                                            <img src="{{ asset('images/profile-img.svg') }}" alt="profile-img"
                                                class="img-fluid" width="128" height="128">
                                        @endif
                                        {{-- <img src="./assets/imgs/profile-img.svg" alt="profile-img" class="img-fluid" width="128" height="128"> --}}
                                    </div>
                                    <div class="col-lg-7">
                                        <div class="details">
                                            <span class="title fw-bold text-theme-primary">{{ $re->name }}</span>
                                            <p class="line-climp">{{ $re->description }}</p>
                                            @foreach ($re->features as $fea)
                                                <span class="badge bg-primary">{{ $fea->name }}</span>
                                            @endforeach
                                        </div>
                                    </div>
                                    <div class="col-lg-3">
                                        <div class="btns d-flex flex-column">
                                            <a href="{{ route('recruiter.detail', $re->id) }}"
                        ...
                        <!-- <div class="card horizontal-view py-3 mb-3">
                            <div class="card-body row align-items-center">
                                ...
                                <div class="col-lg-7">
                                    <div class="details">
                                        <span class="title fw-bold text-theme-primary">Recruiters Name</span>
                                        <p class="line-climp">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita ipsum reprehenderit dolores quo iure qui sit. Nisi, perspiciatis amet quisquam pariatur officia aperiam sequi minima laborum eos, id at? Repellendus?
                                        </p>
                                        <span class="badge bg-primary">Lorem ipsum dolor</span>
                                        <span class="badge bg-primary">Lorem ipsum dolor</span>
                                        <span class="badge bg-primary">Lorem ipsum</span>
                                        <span class="badge bg-primary">Lorem ipsum dolor</span>
                                    </div>
                                </div>
                                <div class="col-lg-3">
