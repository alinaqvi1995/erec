            ...
            <div class="container">
                <div class="card" style="width: 100%">
                    <div class="card-header">
                        @if($comp->logo != NULL)
                            <div id="imagePreview" style="background-image: url({{ asset('storage/'.$comp->logo) }});">
                            </div>
                        @else
                    ...
                    <div class="card-body">
                        ...
                        <p class="ml-4 card-text">{{ $comp->country_code }} {{ $comp->phone }}</p>
                        <h6 class="card-subtitle  text-muted">ACN/ ABN #.</h6>
                        <p class="ml-4 card-text">{{ $comp->abn }}</p>
