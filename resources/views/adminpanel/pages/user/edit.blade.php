        ...
        <form method="post" action="{{ route('admin.approveUser') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" disabled class="form-control fs-14 h-50px" name="name" value="{{ $user->name }}" placeholder="Skill Name" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="name" class="form-label fs-14 text-theme-primary fw-bold">Email</label>
                    <input type="text" disabled class="form-control fs-14 h-50px" name="name" value="{{ $user->email }}" placeholder="Skill Name" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select id="role" name="role" class="form-control fs-14 h-50px">
                        ...
                        <option value="user" @if($user->role == "user") selected @endif>Candidate</option>
                        <option value="company" @if($user->role == "company") selected @endif>Company</option>
                        <option value="rec" @if($user->role == "rec") selected @endif>Recruiter</option>
                    </select>
                </div>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <button type="submit" class="w-25 btn btn-primary"> Approve </button>
                </div>
            </div>
        </form>
    </div>
