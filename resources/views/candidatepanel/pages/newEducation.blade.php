        ...
        <form method="post" action="{{ route('candidates.education.update') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control fs-14 h-50px" name="institute[]" value="" placeholder="Institute" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="institute_loc" class="form-label fs-14 text-theme-primary fw-bold">Institute Location</label>
                    <input type="text" class="form-control fs-14 h-50px" name="institute_loc[]" value="" placeholder="Institute Location" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
                    <label for="passing_year" class="form-label fs-14 text-theme-primary fw-bold">Passing Year</label>
                    <input type="text" class="form-control fs-14 h-50px" name="passing_year[]" value="" placeholder="Passing Year" required>
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row align-items-center row-cols-lg-2">
                <div class="col-lg-2">
                    <div class="avatar-upload">
                            ...
                            ="imagePreview" style="background-image: url({{ asset('storage/'.$user->avatar) }});">
                                </div>
                                @else
